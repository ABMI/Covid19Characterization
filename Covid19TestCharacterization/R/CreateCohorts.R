...
.createCohorts <- function(connection,
  ...
  pathToCsv <- system.file("cohorts", "InclusionRules.csv", package = "Covid19TestCharacterization")
  ...
  # Instantiate cohorts:
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "Covid19TestCharacterization")
